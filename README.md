...
- PAL or NTSC (automatically detected via GTIA `$D014` PAL register)
...
PokeyMAX registers used:
  ...
  $D014        GTIA PAL register (PAL/NTSC VBI-rate detection)
```
...
Amiga Paula clock ≈ PAL_PAULA_CLOCK Hz for the current sample-period mapping.
PokeyMAX core clock = 2 × φ2 ≈ PAL_PAULA_CLOCK.
